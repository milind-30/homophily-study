...
sns.despine()
fig_path = os.path.join("figures", "pointplot_chosen_vs_simDiff_condition.png")
...
g.set_axis_labels("Self-Similarity Gap", "Preference Rate")
g.set_titles(col_template="{col_name}")
g.fig.subplots_adjust(top=0.85)

facet_fig_path = os.path.join("figures", "pointplot_chosen_vs_simDiff_condition.png")
...
# %%
table_filename = os.path.join("tables", "table_chosen_vs_simDiff_condition.md")
with open(table_filename, "w", encoding="utf-8") as f:
...
# Save figure
facet_fig_path = os.path.join("figures", "facetgrid_chosen_vs_simDiff_Task_Condition.png")
...
# %%
table_filename = os.path.join("tables", "table_chosen_vs_simDiff_task_cond.md")
with open(table_filename, "w", encoding="utf-8") as f:
