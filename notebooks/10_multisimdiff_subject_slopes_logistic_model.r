...
summary_path <- "statistics/multisimdiff_subject_slopes_logistic_model.md"
table_path <- "tables/table_multisimdiff_condition_subject_slopes.md"
...
model <- withCallingHandlers(
  glmer(
    chosen ~ (simDiffRace + simDiffAge + simDiffGender) * condition +
      (1 | character) +
      (0 + simDiffRace + simDiffAge + simDiffGender | subject),
    data = df,
